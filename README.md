...
| page_help_needed.py | "plus" and "minus" button of cognitive load input field | Click on "plus" or "minus" button | The value of the field is increased or decreased, respectively, by one decimal place | passed | ![Help-Needed-page-with-no-results-displayed](readmedocs/Help-Needed-page-with-no-results-displayed.png "Help Needed page with no results displayed")![Help-Needed-page-cognitive-load-plus-button-clicked](readmedocs/Help-Needed-page-cognitive-load-plus-button-clicked.png "Help Needed page cognitive load plus button clicked")![Help-Needed-page-cognitive-load-minus-button-clicked](readmedocs/Help-Needed-page-cognitive-load-minus-button-clicked.png "Help Needed page cognitive load minus button clicked") |
| page_help_needed.py | "plus" and "minus" button of caffeine intake input field | Click on "plus" or "minus" button | The value of the field is increased or decreased, respectively, by an integer | passed | ![Help-Needed-page-with-no-results-displayed](readmedocs/Help-Needed-page-with-no-results-displayed.png "Help Needed page with no results displayed")![Help-Needed-page-caffeine-intake-plus-button-clicked](readmedocs/Help-Needed-page-caffeine-intake-plus-button-clicked.png "Help Needed caffeine intake load plus button clicked")![Help-Needed-page-caffeine-intake-minus-button-clicked](readmedocs/Help-Needed-page-caffeine-intake-minus-button-clicked.png "Help Needed page caffeine intake minus button clicked") |
| page_help_needed.py | cognitive load and caffeine intake input fields | Selecting a field | The cursor focuses on the selected field | passed | ![Help-Needed-page-cognitive-load-input-field-selected](readmedocs/Help-Needed-page-cognitive-load-input-field-selected.png "Help Needed page cognitive load input field selected")![Help-Needed-page-caffeine-intake-input-field-selected](readmedocs/Help-Needed-page-caffeine-intake-input-field-selected.png "Help Needed page caffeine intake input field selected") |
| page_help_needed.py | 'Run Help Analysis' button | Click on button | A message is displayed about whether or not the developer will achieve the productivity goal set for the day, how likely the statement is and if the developer needs additional help. | passed | ![Help-Needed-page-with-no-results-displayed](readmedocs/Help-Needed-page-with-no-results-displayed.png "Help Needed page with no results displayed")![Help-Needed-page-with-results-displayed](readmedocs/Help-Needed-page-with-results-displayed.png "Help Needed page with results displayed") |
